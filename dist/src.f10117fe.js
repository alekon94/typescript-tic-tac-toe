...
function createCell(row, col) {
  ...
  cell.addEventListener("click", function () {
    ...
    if (boardState[row][col] === "") {
      ...
      currentMove = currentMove === "X" ? "0" : "X"; // eslint-disable-next-line @typescript-eslint/no-use-before-define

      winner = checkBoard(); // eslint-disable-next-line @typescript-eslint/no-use-before-define
